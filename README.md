...
<a href="https://skillicons.dev">
  <img src="https://skillicons.dev/icons?i=java,spring,python,fastapi,django,flask" />
</a>

**Database & Middleware**

<a href="https://skillicons.dev">
  <img src="https://skillicons.dev/icons?i=mysql,redis,postgres,rabbitmq,mongodb" />
</a>

**DevOps & Frontend**

<a href="https://skillicons.dev">
  <img src="https://skillicons.dev/icons?i=docker,nginx,linux,git,js,vue" />
</a>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>🏛️ GOJ - 在线判题系统</h3>
      <sup><code>Java</code> <code>Spring Boot</code> <code>Docker</code> <code>Redis</code></sup>
      <br/><br/>
      开源在线编程评测平台，支持多语言提交与沙箱隔离执行，包含题目管理、判题队列、代码沙箱等核心模块。
    </td>
    <td width="50%" valign="top">
      <h3>📊 <a href="https://codebuildream.blog.csdn.net/article/details/141330011">Python 数据分析项目集</a></h3>
      <sup><code>Python</code> <code>Pandas</code> <code>NumPy</code> <code>Matplotlib</code></sup>
      <br/><br/>
      累计 <b>350+</b> 原创数据分析项目，涵盖数据清洗、特征工程、可视化、机器学习建模全流程。
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3>🏠 <a href="https://erdayi.github.io/Home_Page/">Personal Home Page</a></h3>
      <sup><code>Flask</code> <code>Tailwind CSS</code> <code>GitHub Actions</code></sup>
      <br/><br/>
      个人主页，GitHub Actions 每日自动构建部署，动态展示 GitHub 数据与技术栈。
    </td>
    <td width="50%" valign="top">
      <h3>🤖 <a href="https://github.com/erdayi/auto-fill-resume">Auto Fill Resume</a></h3>
      <sup><code>JavaScript</code> <code>Chrome Extension</code></sup>
      <br/><br/>
      简历信息自动填写助手，支持 Chrome/Edge，智能识别表单字段一键填写。
    </td>
  </tr>
</table>
...
|:-----|:--------|
| 微信公众号 | **码界筑梦坊** |
| 小红书 | [码界筑梦坊](https://xhslink.com/m/48UWaiJTV7M) |
| 咸鱼 | [码界筑梦坊](https://m.tb.cn/h.SEUD1KR) |
| QQ | **3786612605** |
